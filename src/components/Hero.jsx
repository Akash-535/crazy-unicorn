...
const Hero = () => {
  return (
    <div className='relative'>
      <img className='absolute left-0 top-[20%] max-2xl:max-w-96 max-xl:max-w-72 max-md:hidden' src="./assets/images/svg/hero-left-stars.svg" alt="stars" />
      <img className='absolute right-0 bottom-10 max-2xl:max-w-96 max-xl:max-w-72 max-md:hidden' src="./assets/images/svg/hero-right-stars.svg" alt="stars" />
     <Header/>
