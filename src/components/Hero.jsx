    ...
    <div className="relative">
      ...
      <div className="relative pt-[165px] max-2xl:pt-24 max-xl:pt-16 max-lg:pt-0">
        <div className="max-w-[1304px] mx-auto max-2xl:max-w-[1000px] max-xl:max-w-[750px] max-lg:max-w-[550px] px-5">
          ...
          />
          <img
            className="max-w-[600px] absolute top-[52%] z-[2] left-1/2 -translate-x-1/2 max-2xl:max-w-[490px] max-2xl:top-[48%] w-full max-xl:max-w-[370px] max-lg:max-w-[260px] max-lg:top-[40%] max-[524px]:max-w-[166px] pointer-events-none"
            src="./assets/images/webp/hero-horse-img.webp"
            alt="horse img"
          />
        </div>
      </div>
