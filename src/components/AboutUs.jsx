...
const AboutUs = () => {
  return (
    ...
    >
      <Lottie
        className="absolute -bottom-1/2 left-0 max-2xl:max-w-96 max-xl:max-w-72 max-md:hidden max-xl:bottom-0 -z-[1] pointer-events-none"
        animationData={leftLottie}
      />
      <Lottie
        className="absolute right-0 -top-1/2 max-2xl:max-w-96 max-xl:max-w-72 max-md:hidden max-xl:-top-4 -z-[1] pointer-events-none"
      ...
      <div className="container">
        <div className="flex items-center gap-[83px] max-2xl:gap-14 justify-center max-xl:flex-wrap-reverse max-xl:gap-9 max-md:gap-5">
          <img
            ...
            alt="about us image"
          />
          <div className="max-xl:flex flex-col justify-center items-center pt-28 max-xl:pt-0">
            ...
            <div className="bg-gradient-to-l from-pink-dark to-neon-pink max-w-[234px] rounded-xl mt-14 max-xl:mt-10 max-lg:mt-7 max-md:mt-4 max-md:max-w-[190px]">
              <button className="bg-white py-4 px-12 border-[0.5px] border-black rounded-xl -translate-x-1.5 -translate-y-1.5 hover:translate-x-0 hover:translate-y-0 duration-300 ease-linear max-md:px-6 max-md:py-2">
