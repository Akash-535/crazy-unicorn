  ...
  return (
    <div id='faq' className="bg-faq-bg-img bg-no-repeat bg-cover bg-center">
      <div className="container xl:pb-[132px] lg:pb-24 pb-16 mx-auto max-xl:px-4 xl:pt-[103px] md:pt-16 pt-12">
        <div className='relative text-center max-w-[161px] mx-auto'>
          <img className='max-w-[118px] absolute -top-8 max-lg:-top-14 -right-11 max-lg:-right-10 max-sm:-right-8' src="./assets/images/webp/little-horse-image.webp" alt="little horse" />
