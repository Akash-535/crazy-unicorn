  ...
  return (
    <div className=" relative flex items-center justify-center">
      <img
        ...
        src="./assets/images/svg/footer-stars.svg"
        alt="stars"
      />
      <div className="flex lg:pt-44 pt-28 flex-col z-10 items-center justify-center">
        ...
        <div className="flex gap-[21px] sm:pt-[60px] pt-8 pb-4 sm:pb-16">
        ...
        <p className="sm:text-xl opacity-70 font-comic sm:pb-16 pb-10">
