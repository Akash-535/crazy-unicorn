  ...
  return (
    <div className="overflow-hidden mx-auto px-5 pt-1.5">
      <div className="container flex justify-between items-center">
        ...
        <div
          className={`flex gap-[30px] max-lg:gap-6 max-lg:flex-col max-lg:justify-center max-lg:items-center max-lg:fixed max-lg:top-0 max-lg:w-full max-lg:h-full max-lg:bg-gradient-to-r max-lg:from-pink-200 max-lg:to-pink-400 duration-300 ease-linear z-10 ${
